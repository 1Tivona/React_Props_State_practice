              ...
              <div className="card-block">
                ...
                <form onSubmit={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea className="form-control" name="commentText"  rows="3" type="text" value={this.state.commentText} onChange={this.handleCommentTextChange} />
                  </div>
                  <div className="form-group">
                    <input className="form-control col-md-3" name="name"  type="text" value={this.state.name} onChange={this.handleNameChange}/>
                  </div>
